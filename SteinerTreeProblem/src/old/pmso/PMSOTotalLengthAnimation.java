...
import old.pmso.PMSOTotalLength.Particle;
...
public class PMSOTotalLengthAnimation {
	
	private PMSOTotalLength solver;
	private int steps;
	private DrawConfig drawcfg;
	private int sleep;
	public PMSOTotalLengthAnimation(PMSOTotalLength solver, int steps, int sleep,DrawConfig drawcfg) {
		this.solver = solver;
		this.steps = steps;
	...
	class DrawPanel extends JPanel{
		...
		public void paintComponent(Graphics g) {
		    ...
		    g.drawString("Length: " + solver.getSteinerTree().getLength() , 150, 50);
		}
